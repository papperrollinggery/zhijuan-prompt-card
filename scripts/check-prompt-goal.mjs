...
const contractChecks = [
  ...
  ['generator handoff avoids reference-image requests', 'Do not write source image, reference image, recreate this image, or ask for an uploaded/reference image'],

...
- For copied generator prompts: Do not write source image, reference image, recreate this image, or ask for an uploaded/reference image in zh.prompt, en.prompt, json_prompt.generation_prompt, or prompt_core. Describe the target visual.

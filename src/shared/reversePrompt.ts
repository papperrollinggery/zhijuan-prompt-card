...
- For copied generator prompts: Do not write source image, reference image, recreate this image, or ask for an uploaded/reference image in zh.prompt, en.prompt, json_prompt.generation_prompt, or prompt_core. Describe the target visual directly.
...
- Do not include generator-specific syntax such as --ar, --s, --raw, --iw, --no, BREAK, weights, LoRA tags, model parameters, or bracketed prompt tokens in en.prompt or prompt_core.

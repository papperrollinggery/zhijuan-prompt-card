...

{
  ...
  "json_prompt": {
    ...
    "composition_framing": "observed orientation, aspect, distance, angle, crop, scale, placement, perspective, negative space, focus, depth",
    ...
    "aspect_ratio": "observed source-frame ratio such as 2:3, 3:4, 1:1, or 16:9",
...
- Lock source frame early: orientation, aspect, crop, and edge cuts. Portrait posters stay portrait; vertical screenshots stay vertical; square sources stay square.
...
- negative_prompt is image-specific, 8-24 items. Block drift: wrong identity/source, count, face/body/skin tone, pose, surface/material, unreadable/moved/translated text, redesigned UI/layout, wrong orientation/aspect ratio, wrong crop/viewpoint, missing props, extra objects, over-polish, artifacts. Portrait/vertical sources block horizontal, landscape, and widescreen drift; landscape/horizontal sources block portrait and vertical drift. For curved, diagonal, irregular, organic, or continuous geometry, block straightened bands, rectangular panels, uniform grids, equalized zones, and lost boundary lines. Do not stack generic blockers.
